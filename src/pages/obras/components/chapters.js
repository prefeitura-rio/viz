...
export function Intro(
  ...
  return (
    <styles.IntroDiv className="bg-[#82ba78]" ref={props.chapRef} id={props.id}>
...
export function NumeraoUm(
  ...
  return (
    <styles.ChapterGenericDiv className="bg-[#639ed8]" ref={props.chapRef} id={props.id}>
    ...
    <styles.ChapterGenericDiv2 className="" ref={props.chapRef} id={props.id}>
      <styles.ContainerCard2>
          <styles.Grid1>
            ...
            <styles.BigNumber4>Esse é o Conjunto Habitacional <styles.TextHighlightGreen>Condomínio</styles.TextHighlightGreen><styles.TextHighlightGreen>Parque</styles.TextHighlightGreen> <styles.TextHighlightGreen>Novo Irajá</styles.TextHighlightGreen>, no bairro de Irajá 
            </styles.BigNumber4>
      </styles.ContainerCard2>

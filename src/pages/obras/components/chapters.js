...
export function NumeraoConjuntoMaravilha(
  ...
  return (
    <styles.ChapterGenericDiv2 className="" ref={props.chapRef} id={props.id}>
      <styles.ContainerCard2>
            <styles.BigNumber4>Esse é o Conjunto Habitacional Condomínio Parque Novo  Irajá, no bairro de Irajá 
            </styles.BigNumber4>
      </styles.ContainerCard2>
    </styles.ChapterGenericDiv2>
  );
...
export function NumeraoConjuntoMaravilhaUm(
  ...
  return (
    <styles.ChapterGenericDiv2 className="" ref={props.chapRef} id={props.id}>
      <styles.ContainerCard2>
            <styles.BigNumber4>Localizado na Avenida Brasil, o conjunto é formado por 15 prédios, divididos em 26 blocos. O empreendimento residencial teve sua fachada totalmente reformada em janeiro deste ano pelo programa Conjunto Maravilha
          </styles.BigNumber4>
      </styles.ContainerCard2>
    </styles.ChapterGenericDiv2>
  );
...
export function TextoConjuntoMaravilha(
  ...
  return (
    <styles.IntroDiv className="bg-[#a9d3a2]" ref={props.chapRef} id={props.id}>
      <img src={conjuntomaravilha} className="w-auto h-[250px] lg:h-[400px] lg:order-last"></img>
      <div className="max-w-[80%]">
        {" "}
        <styles.IntroText>
        Revitalizar unidades habitacionais da cidade do Rio é a missão do <styles.TextHighlightBold> Conjunto Maravilha</styles.TextHighlightBold>, programa da Rio-Urbe, órgão ligado à Secretaria Municipal de Infraestrutura.
        <br/><br/>
...
export function NumeraoCasaCarioca(
  ...
  return (
    <styles.ChapterGenericDiv2 className="" ref={props.chapRef} id={props.id}>
      <styles.ContainerCard2>
            <styles.BigNumber4>E aqui está ocomplexo do Jacarezinho
            </styles.BigNumber4>
      </styles.ContainerCard2>
    </styles.ChapterGenericDiv2>
  );
...
export function NumeraoCasaCariocaUm(
  ...
  return (
    <styles.ChapterGenericDiv2 className="" ref={props.chapRef} id={props.id}>
      <styles.ContainerCard2>
            <styles.BigNumber4>Por aqui, o programa Casa Carioca transformou a casa — e a vida — de famílias em situação de vulnerabilidade social.</styles.BigNumber4>
      </styles.ContainerCard2>
    </styles.ChapterGenericDiv2>
  );
}
...
export function NumeraoAvancaCampoGrande(
  ...
  return (
    <styles.ChapterGenericDiv2 className="" ref={props.chapRef} id={props.id}>
      <styles.ContainerCard2>
            <styles.BigNumber4>É aqui que Campo Grande receberá a maior obra da Prefeitura, o Anel Viário 
            </styles.BigNumber4>
      </styles.ContainerCard2>
    </styles.ChapterGenericDiv2>
  );
...
export function NumeraoAvancaCampoGrandeUm(
  ...
  return (
    <styles.ChapterGenericDiv2 className="" ref={props.chapRef} id={props.id}>
      <styles.ContainerCard2>
            <styles.BigNumber4>O projeto Avança Campo Grande vai reduzir pela metade o tempo entre o centro do bairro e a Avenida Brasil.
          </styles.BigNumber4>
      </styles.ContainerCard2>
    </styles.ChapterGenericDiv2>
  );
...
export function TextoAvancaCampoGrande(
  ...
  return (
    <styles.IntroDiv className="bg-[#639ed8]" ref={props.chapRef} id={props.id}>
      <img src={avancacampogrande} className="w-auto h-[180px] lg:h-[300px] lg:order-last"></img>
      <div className="max-w-[80%]">
        {" "}
        <styles.IntroText>
        Além disso, uma série de obras estão previstas para melhorar o trânsito e a qualidade de vida no maior bairro do Brasil, é o <styles.TextHighlightBold> Avança Campo Grande</styles.TextHighlightBold> levando desenvolvimento e prosperidade para a Zona Oeste do Rio.
        <br/><br/>
...
export function NumeraoBairroMaravilha(
  ...
  return (
    <styles.ChapterGenericDiv2 className="" ref={props.chapRef} id={props.id}>
      <styles.ContainerCard2>
            <styles.BigNumber4>Os moradores do Encantado foram beneficiados com diversas obras de urbanização e infraestrutura no bairro
            </styles.BigNumber4>
      </styles.ContainerCard2>
    </styles.ChapterGenericDiv2>
  );
...
export function NumeraoBairroMaravilhaUm(
  ...
  return (
    <styles.ChapterGenericDiv2 className="" ref={props.chapRef} id={props.id}>
      <styles.ContainerCard2>
            <styles.BigNumber4>A região está recebendo 13 obras do programa, com investimentos que chegam a R$ 240 milhões. Presente em mais de 90 localidades da cidade do Rio, o programa Bairro Maravilha está evando obras de recuperação e melhorias nas ruas das zonas Norte e Oeste
          </styles.BigNumber4>
      </styles.ContainerCard2>
    </styles.ChapterGenericDiv2>
  );
...
export function TextoBairroMaravilha(
  ...
  return (
    <styles.IntroDiv className="bg-[#d66262]" ref={props.chapRef} id={props.id}>
      <img src={bairromaravilha} className="w-auto h-[250px] lg:h-[400px] lg:order-last"></img>
      <div className="max-w-[80%]">
        {" "}
        <styles.IntroText>
        Além dos moradores de Encantado, as entregas mais recentes também beneficiaram moradores de Campo Grande.
        <br/><br/>
        O <styles.TextHighlightBold> Bairro Maravilha</styles.TextHighlightBold> tem como missão resgatar pontos da cidade que historicamente sofrem com a falta de infraestrutura urbana. O objetivo é tirar essas áreas da degradação e abandono.
        <br/><br/>
  ...
  return (
    <styles.IntroDivUm className="bg-[#639ed8]" ref={props.chapRef} id={props.id}>
      ...
      <div className="max-w-[80%]">
        {" "}
        <styles.IntroText>
        A Prefeitura vem investimento, de grandes obras a pequenas melhorias, para priorizaras pessoas e regiões que sempre ficaram para trás. 
        <br/><br/>
        É a gente trabalhando para quem mais precisa. De grandes obras a pequenas melhorias, a gente prioriza as pessoas e regiões que sempre ficaram para trás.
        <br/><br/>
        <styles.TextHighlightBold>É a Prefeitura trabalhando na sua casa, na sua rua, no seu Rio.</styles.TextHighlightBold> 
   </styles.IntroText>
      </div>
    </styles.IntroDivUm>
  );

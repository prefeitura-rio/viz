...
export function QuadroUm(props) {
	...
	return (
		<styles.ChapterGenericDiv2 ref={sectionRef} id={props.id}>
			...
			<styles.ContainerCard3 id={"quadro_um_card9"} className=" top-[2200vh]">
				<styles.TextCard3>
			...
			<styles.ContainerCard3 id={"quadro_um_card13"} className=" top-[3300vh]">
				<styles.TextCard3>
					Como foi o caso de Mauro, 53 anos, morador da Tijuca.					</styles.TextCard3>
			</styles.ContainerCard3>
			<styles.ContainerCard3 id={"quadro_um_card14"} className=" top-[3400vh]">
				<styles.TextCard3>
					Ele foi encaminhado por uma Clínica da Família para consulta com um pneumologista no CCE. 					</styles.TextCard3>
			</styles.ContainerCard3>
			<styles.ContainerCard3 id={"quadro_um_card15"} className=" top-[3600vh]">
				<styles.TextCard3>
			...
			<styles.ContainerCard3 id={"quadro_um_card16"} className=" top-[4000vh]">
				<styles.TextCard3>
			...
			<styles.ContainerCard3 id={"quadro_um_card18"} className=" top-[4100vh]">
				<styles.TextCard3>
					O médico solicitou uma tomografia e depois de exames, Mauro foi diagnosticado com câncer nos pulmões.

				</styles.TextCard3>
			</styles.ContainerCard3>
			<styles.ContainerCard3 id={"quadro_um_card19"} className=" top-[4200vh]">
				<styles.TextCard3>
			...
			<styles.ContainerCard3 id={"quadro_um_card20"} className=" top-[4300vh]">
				<styles.TextCard3>
					O equipamento de PET Scan do CCD é o único da rede municipal de saúde.

				</styles.TextCard3>
			</styles.ContainerCard3>
			<styles.ContainerCard3 id={"quadro_um_card21"} className=" top-[4450vh]">
				<styles.TextCard3>
					O CCD conta ainda com diversos outros equipamentos modernos para todo tipo de exames e procedimentos.

				</styles.TextCard3>
			</styles.ContainerCard3>
			<styles.ContainerCard3 id={"quadro_um_card22"} className=" top-[4950vh]">
				<styles.TextCard3>
			...
			<styles.ContainerCard3 id={"quadro_um_card23"} className=" top-[5050vh]">
				<styles.TextCard3>
					Maria, 55 anos, de Irajá, tem catarata.
				</styles.TextCard3>
			</styles.ContainerCard3>
			<styles.ContainerCard3 id={"quadro_um_card24"} className=" top-[5150vh]">
				<styles.TextCard3>
					Ela veio ao Centro Carioca do Olho (Hospital do Olho).
				</styles.TextCard3>
			</styles.ContainerCard3>
			<styles.ContainerCard3 id={"quadro_um_card26"} className=" top-[5250vh]">
				<styles.TextCard3>

  ...
  return (
    <styles.IntroDiv ref={props.chapRef} id={props.id}>
      ...
      <styles.IntroText>
        ...
        fiscalização, há inúmeras famílias que vivem sob o risco de perderem, a
        qualquer momento, suas casas, sua história e também suas vidas.
      </styles.IntroText>
    </styles.IntroDiv>
  );
}
...
export function Mapa(
  ...
  return (
    <styles.ChapterGenericDiv ref={props.chapRef} id={props.id}>
      <styles.ContainerCard>
        <styles.TextCard1>Manguinhos (219 demolições), Recreio dos Bandeirantes (214 demolições),
          Gardênia Azul (178 demolições), Jacarepaguá (90 demolições) e Campo Grande (67 demolições)
          foram os cinco bairros com mais ações realizadas. Outros bairros localizados na Zona Sul, como
          Botafogo (33 demolições) e São Conrado (27 demolições),e da Zona Norte, como Del Castilho (38 demolições)
          e Mangueira (14 demolições) também tiveram construções irregulares identificadas e demolidas pelo poder público.
        </styles.TextCard1>
      </styles.ContainerCard>
    </styles.ChapterGenericDiv>
  );
  ...
  return (
    <styles.IntroDiv ref={props.chapRef} id={props.id}>
      ...
      <styles.IntroText>
        ...
        mais de 70% estavam localizadas na região. Os bairros do Recreio e Gardênia Azul, 
        por exemplo, são os que registram maior incidência destas irregularidades.
      </styles.IntroText>
    </styles.IntroDiv>
  );
}
